...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <section className="w-full bg-nudge-gradient flex flex-col items-center justify-center py-28 md:py-36 lg:py-48 text-center min-h-[75vh] md:min-h-[65vh] px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-10 md:mb-12">
            {/* Animation class removed from this div */}
            <div className="relative group rounded-lg"> 
              ...
              />
              {/* The overlay div for gentle-logo-pulse was here, it's removed if you don't want any overlay effect. 
                  If you had a different overlay for other purposes, it would go here.
                  For turning off the 'animate-gentle-logo-pulse' specifically, 
                  if it was on the overlay, that overlay div or its animation class would be removed.
                  If the 'animate-logo-container-glow' was on this parent div, that class is now removed.
              */}
            </div>
          </div>
      ...
      <section id="how-it-works-gps" className="py-16 md:py-28 bg-black">
      ...
      <section className="py-16 md:py-28 bg-dark">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 md:mb-20">
